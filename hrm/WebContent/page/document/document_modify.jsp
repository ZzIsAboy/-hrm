...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img src="${pagePath}/page/static/images/pointer.gif">&nbsp;当前位置：文档管理&nbsp;&gt;&nbsp;修改文档</td>
	...
	<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		<tr valign="top">
			<td>
				<form id="documentForm" name="documentForm" action="${pagePath}/document/modify_save.do" enctype="multipart/form-data" method="post">
					<!-- 隐藏表单 -->
					<input type="hidden" name="id" value="${document.id}">
					<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						<tr>
							<td class="font3 fftd">文档标题：<input type="text" name="title" size="30" id="title" value="${document.title}" /></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
						<tr>
							<td class="font3 fftd">文档描述：<br /> <textarea name="remark" cols="88" rows="11" id="remark">${document.remark}</textarea>
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd"><input type="button" id="btn" value="确定">&nbsp;&nbsp;<input type="button" onclick="location.href='${pagePath}/notice/list.do'" value="取消 "></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
