...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img src="${pagePath}/page/static/images/pointer.gif">&nbsp;当前位置：员工管理&nbsp;&gt;&nbsp;添加员工</td>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
		<tr valign="top">
			<td>
				<form action="${pagePath}/employee/add.do" id="employeeForm" method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr>
							<td class="font3 fftd">政治面貌：<input name="party" id="party" size="40" />&nbsp;&nbsp;QQ&nbsp;号码：<input name="qq" id="qq" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">联系地址：<input name="address" id="address" size="40" />&nbsp;&nbsp;邮政编码：<input name="postCode" id="postCode" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">出生日期：<input onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});" name="birthday" id="birthday" size="40" />&nbsp;&nbsp;民&nbsp;&nbsp;族：<input name="race" id="race" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">所学专业：<input name="speciality" id="speciality" size="40" />&nbsp;&nbsp;爱&nbsp;&nbsp;好：<input name="hobby" id="hobby" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">备&nbsp;&nbsp;注：<input name="remark" id="remark" size="40" />&nbsp;&nbsp;所属部门： <select id="department_id" name="department_id" style="width: 100px;">
